...
namespace DirectX
{
    namespace SimpleMath
    {
        ...
        struct Vector2 : public XMFLOAT2
        {
            ...
            explicit Vector2(float ix) noexcept : XMFLOAT2(ix, ix) {}
            Vector2(float ix, float iy) noexcept : XMFLOAT2(ix, iy) {}
        ...
        struct Vector3 : public XMFLOAT3
        {
            ...
            explicit Vector3(float ix) noexcept : XMFLOAT3(ix, ix, ix) {}
        ...
        struct Vector4 : public XMFLOAT4
        {
            ...
            explicit Vector4(float ix) noexcept : XMFLOAT4(ix, ix, ix, ix) {}
        ...
        struct Plane : public XMFLOAT4
        {
            ...
            Plane(float ix, float iy, float iz, float iw) noexcept : XMFLOAT4(ix, iy, iz, iw) {}
        ...
        struct Quaternion : public XMFLOAT4
        {
            ...
            Quaternion(float ix, float iy, float iz, float iw) noexcept : XMFLOAT4(ix, iy, iz, iw) {}
        ...
        struct Color : public XMFLOAT4
        {
            ...
            Color(float _r, float _g, float _b) noexcept : XMFLOAT4(_r, _g, _b, 1.f) {}
            Color(float _r, float _g, float _b, float _a) noexcept : XMFLOAT4(_r, _g, _b, _a) {}
